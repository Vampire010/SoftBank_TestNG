...
public class Kb_Regestartion_Page extends Browser_Config
{
	String First_Name = "Sony";
	String Last_Name = "Sony";
	String Your_Email = "gorlesonyqa@gmail.com";
	String Re_enter_Email = "gorlesonyqa@gmail.com";
	String Password = "sony1234";
