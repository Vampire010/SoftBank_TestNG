...
public class Make_Deposit_To_Accounts extends Kb_Login_Page
{
	...
	public void Make_Deposit_In_To_Accounts() throws InterruptedException
	{
		...
		WebElement Confirm_Deposit_Submit = driver.findElement(By.xpath("/html/body/table/tbody/tr/td/table[2]/tbody/tr/td/table/tbody/tr[3]/td[3]/table/tbody/tr/td/table/tbody/tr[6]/td/div[2]/span[1]"));
